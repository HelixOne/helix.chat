...
angular.module('app').factory('api', function($rootScope, $http, $window) {
    ...
    api.posts = {
        ...
        archive: function(id, data){
             return $http({
                method: 'POST',
                url: apiBase + '/communiques/'+ id,
                data: data,
                headers: headers
            });
        },
...
angular.module('app').directive('tasize', function() {
...
// html2canvas(document.querySelector('.user'), {
//   onrendered: function(canvas) {
//    spawnNotification('theBody',canvas.toDataURL(),'theTitle')
//   }
// });